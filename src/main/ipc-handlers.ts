...
import type { SCMProvider, Repository, CommitFilter, UserPreferences, ImportProgress, ScanProgress, LocalRepositoryInfo } from '../shared/types';
...
export function registerIpcHandlers(): void {
  ...
  ipcMain.handle('auth:authenticateWithToken', async (_event, provider: SCMProvider, token: string, username?: string) => {
